                ...
                <div className="container">
                    <div className="git-cont row">
                        ...
                        <div className="col-12 col-sm-6 half">
                            <p className="lead">
                                {contact.pitch}
                                <a href="mailto:JJautomata@protonmail.ch">here.</a>
                            </p>
                    ...
                    {social.github && <a title="Visit Github profile" rel="noopener noreferrer" target="JULIUSHEESE" href={social.github}><i className="fab fa-github"></i></a>}<br/>
                </div> */}
