  ...
  return (
    ...
    <Box bgGradient="linear(to-bl, #f2a900, #4d4d4e)">
        ...
        <Text fontSize="0.69420rem"h="100vh"m={["2.69420%","2.69420%","2.69420%","2.69420%"]} color="#ffffff" >
          ...
          We are headquartered in Chicago, Des Moines {<ReactCountryFlag countryCode="us" />} and Gielinor and have additional headquarters in Estonia {<ReactCountryFlag countryCode="ee" />}. We hold an Estonian activity license for a provider of
